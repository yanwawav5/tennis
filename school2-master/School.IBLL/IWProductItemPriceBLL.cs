...
{
    public interface IWProductItemPriceBLL : IBaseBLL
    {
        /// <summary>
        /// 保存或更新，资源管理链接
        /// </summary>
        ...
        /// 查询单条
        /// </summary>
        ProductItemPriceVO Get(string id);
        ...
        /// <returns></returns>
        List<ProductItemPriceVO> GetList(WIdListBO bo);

        WPriceVO GetPrice(MathBO bo);

        WPriceVO GetEndPrice(MathBO bo);
    }
}
